...
const OrgListContext = createContext<{ orgs: Map<string,DeveloperOrg[]>, dispatch:React.Dispatch<OrgListReducerAction>} | undefined>(undefined);
const LoadingContext = createContext<{isLoading:boolean, setIsLoading:(loading:boolean) => void} | undefined>(undefined);
